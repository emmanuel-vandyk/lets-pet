...
export const signupSchema = z.object({
  ...
  lastName: z
    ...
    .max(20, { message: "El apellido no puede exceder 20 caracteres." }),
  email: z
    .string()
  ...
  confirmPassword: z
    ...
    .max(16, {
      message:
        "La confirmación de la contraseña no puede exceder 16 caracteres.",
    })
    .regex(passwordRegex, {
      message:
        "La confirmación debe coincidir con los requisitos de la contraseña.",
    }),
